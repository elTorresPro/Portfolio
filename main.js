...
function efectoHabilidades() {
    ...
    if (distancia_skills >= 300) {
        ...
        document.getElementById("angular").classList.add("barra-progreso9");
        document.getElementById("ilustraitor").classList.add("barra-progreso10");
        document.getElementById("premier").classList.add("barra-progreso11");
        document.getElementById("ps").classList.add("barra-progreso12");
    }
